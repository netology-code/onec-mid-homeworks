...
2. При необходимости, добавьте в конфигурацию реквизиты, необходимые для заполнения полей печатной формы. 
...
Минимально, в договоре должны быть заполнены: Дата и Номер договора, Отправитель (Организация из документа), Перевозчик (Контрагент), их ИНН и КПП, а так же юридический и почтовый адрес (по контактной информации из справочника, допускается заполнение одним значением из поля "Адрес")
