...
3. В общем модуле УправлениеПечатьюПереопределяемый в методе ПриОпределенииОбъектовСКомандамиПечати добавьте информацию о документе Доставка,  по аналогии с заказом покупателя.
