...
В документе доставка достуен просмотр Связанных документов
...
В системе создано пользователь Менеджер по доставке, у которого нет прав администратора, но доступны документы Доставка
