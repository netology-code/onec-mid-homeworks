...
Важно: если к конкретному документы присоединены файлы, то в строке этого документа в форме списка должна отображаться скрепочка.
...
1. Создайте в конфигураторе роль ДобавлениеИзменениеДоставки, снимите все права, предоставьте все права на документ кроме Интерактивного удаления. Проверьте, что установились права на реквизиты и табличный части документа. Так же не забудьте назначить права справочнику, в котором хранятся присоединенные файлы.
2. Создайте в конфигураторе роль ЧтениеДоставки, снимите все права, предоставьте права Чтение, Просмотр, Ввод по строке. Проверьте, что установились права на реквизиты и табличный части документа. Так же не забудьте назначить права справочнику, в котором хранятся присоединенные файлы.
