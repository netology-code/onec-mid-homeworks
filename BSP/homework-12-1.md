...
(здесь права на контрагента, договор и т.д. унаследованы от менеджера по продажам, но если дать пользователю только базовые права и роль добавленную вами - документ откроется, но во всех ссылочных полях будет "Объект не найден", вместо ссылок)
  ...
  5. В качестве КартинкаЗначений надо указывать не Скрепка, а КоллекцияСкрепка
