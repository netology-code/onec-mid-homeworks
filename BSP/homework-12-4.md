...
8. Сохраните файл отчета и добавьте в качестве дополнительного в справочник Дополнительные отчеты и обработки
...
КонецПроцедуры
```
6. Реализуйте метод ЗагрузитьЗаказыИзФайла, который должен создавать документа Заказы покупателя на основании данных файла
...
7. Добавьте обработку как дополнительную в справочник Дополнительные отчеты и обработки, настройте путь для хранения файла, проверьте работу обработки.
