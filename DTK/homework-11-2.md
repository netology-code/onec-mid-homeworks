...
<details>
  ...
  7. Нельзя просто удалять или менять код типовой конфигурации. Исходный код обязательно должен быть сохранен в виде комментария (см. презентацию)
  8. Убедитесь, что все формы всех документов открываются, позволяют ввести данные
