...
## Цель задания
Используя EDT научиться работсать с 1С xthtp систему контроля версий Git
...
### Процесс выполнения
1. Перейдите к [репозиторию с исходным кодом уже знакомой Вам конфигурации (ЗАМЕНИТЬ ССЫЛКУ НА РЕПОЗИТОРИЙ В АККАУНТЕ НЕТОЛОГИИ)](https://github.com/matvey-seregin/netology-onec-base-11)
...
5. Выполните доработки конфигурации, описанные в прошлых заданиях. (обязательно, выполнить доработку из задания 11 модуля (https://github.com/netology-code/onec-mid-homeworks/blob/main/DTK/homework-11-2.md) Так же, если хотите, можете выполнить задачи 12 модуля.
<details>
