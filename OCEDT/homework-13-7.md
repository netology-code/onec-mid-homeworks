...
5. Выполните доработки конфигурации, описанные в прошлых заданиях. (обязательно, выполнить доработку из задания 11 модуля[домашнего задания к занятию 11-2](../DTK/homework-11-2.md) Так же, если хотите, можете выполнить задачи 12 модуля.
<details>
