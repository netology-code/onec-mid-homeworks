# Командное домашнее задание к занятию «Решение задач оперативного учета_часть 1»
...
Шаг 1
Заполнить инфо о себе в [таблице](https://docs.google.com/spreadsheets/d/1nEFCrhDabUWd1JzmBKBAt5ueUCAtz8m7GEvbGZZDZAU/edit#gid=1242863859&range=B2)

Шаг 2
Самостоятельно разбиться по группам 2-3 человека, с учётом часового пояса, предпочтений и занятости 

Шаг 3
Договариться с командой о дате и времени, когда сможете вместе сделать ДЗ
