# Домашнее задание к занятию «Решение задач на сложные периодические расчеты. Часть 1»
